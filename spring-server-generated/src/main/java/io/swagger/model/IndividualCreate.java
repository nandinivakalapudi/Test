...
public class IndividualCreate {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.id, individualCreate.id) && Objects.equals(this.href, individualCreate.href)
	...
	@Override
	public int hashCode() {
		return Objects.hash(id, href, aristocraticTitle, birthDate, countryOfBirth, deathDate, familyName, fullName,
				gender, baseType, schemaLocation, type);
	}
